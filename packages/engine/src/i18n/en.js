...
export default {
  ...
  rail: { stock: 'Colour', artwork: 'Logo', text: 'Text', placement: 'Place', details: 'Info' },
  drawer: {
  ...
  undo: 'Undo',
  redo: 'Redo',
  placementEmpty: 'Add your artwork or some text to position it on the product.',
  text: {
    defaultContent: 'Your text',
    add: 'Add text',
    addAnother: 'Add another line',
    limit: 'You have reached the maximum number of text lines.',
    hint: 'A name, a slogan, a line of type — set in a typeface you choose.',
    content: 'Text',
