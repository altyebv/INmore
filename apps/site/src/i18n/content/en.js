...
export default {
  ...
  ui: {
    ...
    home: {
      ...
      galleryEyebrow: 'Made for your brand',
      galleryTitle: 'Useful things, made memorable.',
      galleryLede:
        'From a first impression in print to the everyday objects customers carry, we make your identity visible, consistent and worth keeping.',
      products: [
        {
          id: 'gift-boxes',
          image: '/assets/packages.jpeg',
          title: 'Gift boxes',
          body: 'Printed packaging with the finish and presence a thoughtful gift deserves.',
        ...
        },
        {
          ...
          body: 'Business cards, folders and collateral that make every handover feel considered.',
        ...
        },
        {
          ...
          title: 'Custom shirts',
          body: 'High-quality apparel printing for teams, launches, campaigns and events.',
        ...
        },
        {
          ...
          title: 'Branded bags',
          body: 'Carry your message further with practical bags designed around your identity.',
        ...
        },
        {
          ...
          title: 'Coffee cups',
          body: 'Daily visibility for cafés, offices and hospitality brands, printed to order.',
        ...
        },
        {
          ...
          title: 'Office kits',
          body: 'Notebooks, pens and desk essentials assembled into a brand experience people use.',
        ...
        },
        {
          ...
          title: 'Event apparel',
          body: 'Wearable campaign pieces that turn a team or occasion into a shared signal.',
        ...
        },
        {
          ...
          title: 'Retail bags',
          body: 'A branded final touch that keeps your business in view after the purchase.',
        ...
        },
        {
          ...
          title: 'Cup ranges',
          body: 'Coordinated cup formats that keep every service moment on-brand.',
        ...
        },
        {
          ...
          body: 'Practical branded giveaways made to be used, carried and remembered.',
